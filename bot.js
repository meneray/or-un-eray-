...
client.on('guildMemberAdd', member => {
  ...
  const channel = member.guild.channels.find('name', '685594331868168256');
  if (!channel) return;
...
//----------------------------------HOSGELDIN-----------------------------//
client.on("guildMemberAdd", member => {
var rol = member.guild.roles.get("685593863930642468")
var rol2 = member.guild.roles.get("685593863930642468")
member.addRole(rol)
member.addRole(rol2)
   })
//----------------------------------HOSGELDIN-----------------------------//
...
app.listen(8000);
setInterval(() => {
http.get(`http://register12.glitch.me/`);
}, 280000)